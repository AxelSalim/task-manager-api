...
export type CreateFinanceCategorySheetProps = {
  open: boolean;
          ...
          <div className="flex-1 overflow-y-auto px-5 py-5">
            <div className="grid gap-4">
              <div className="grid gap-2">
                <Label htmlFor="create-cat-name">Nom</Label>
                <Input
                  id="create-cat-name"
              ...
              <div className="grid gap-2 w-full">
                <Label htmlFor="create-cat-type">Type</Label>
                <Select value={type} onValueChange={(v) => setType(v as FinanceTransactionType)}>
                  <SelectTrigger id="create-cat-type" className="rounded-sm w-full">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    {typeOptions.map((t) => (
